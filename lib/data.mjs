...
export const categories = ['Temel GençTek etkinliği', 'İl etkinliği', OTHER_KIND];
...
export const subtypes = { [BASIC_KIND]: BASIC_TYPES, 'İl etkinliği': LOCAL_TYPES, [OTHER_KIND]: [] };
...
export function validateEvent(body, user) {
  ...
  if ((options.length && !picked.length) || picked.some(s => !options.includes(s))) gecersiz('En az bir alt tür seçin.');
