...
const BASIC_TYPES = ['Genç Gölge', 'Akran Öğretimi', 'Sahne Senin', 'Sınır Ötesi (Beyond The Borders)', 'Öğrenci Forumu', 'Hack The Idea', "Oyunun e Hâli", 'G2S Genç Sektör Buluşması', 'Dijital Yürüyüş STEM', 'Tek Maraton / Eğitim Teknolojileri Fikir Maratonu', 'Misafir Öğretmenlik / Öğrencilik', 'Hatalarından Ders Çıkar / Harika Bir Başarısızlık Tasarla', 'GençTek Zirvesi', 'Görünürlük / Tanıtım', 'Diğer'];
